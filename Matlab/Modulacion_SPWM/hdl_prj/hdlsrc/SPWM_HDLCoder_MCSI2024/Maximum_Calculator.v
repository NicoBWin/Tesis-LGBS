// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SPWM_HDLCoder_MCSI2024\Maximum_Calculator.v
...
module Maximum_Calculator
  ...
  wire signed [8:0] Subtract1_sub_temp;  // sfix9
  wire signed [8:0] Subtract1_1;  // sfix9
  wire signed [8:0] Subtract1_2;  // sfix9
  ...
  wire signed [8:0] Subtract2_sub_temp;  // sfix9
  wire signed [8:0] Subtract2_1;  // sfix9
  wire signed [8:0] Subtract2_2;  // sfix9
  ...
  assign Subtract_1 = {1'b0, alpha3_phase_Vab0};
  assign Subtract_2 = {1'b0, alpha3_phase_Vab120};
  assign Subtract_sub_temp = Subtract_1 - Subtract_2;
  assign Subtract_out1 = {{7{Subtract_sub_temp[8]}}, Subtract_sub_temp};
  ...
  assign Subtract1_1 = {1'b0, alpha3_phase_Vab120};
  assign Subtract1_2 = {1'b0, alpha3_phase_Vab240};
  assign Subtract1_sub_temp = Subtract1_1 - Subtract1_2;
  assign Subtract1_out1 = {{7{Subtract1_sub_temp[8]}}, Subtract1_sub_temp};
  ...
  assign Subtract2_1 = {1'b0, alpha3_phase_Vab240};
  assign Subtract2_2 = {1'b0, alpha3_phase_Vab0};
  assign Subtract2_sub_temp = Subtract2_1 - Subtract2_2;
  assign Subtract2_out1 = {{7{Subtract2_sub_temp[8]}}, Subtract2_sub_temp};
