// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SPWM_HDLCoder_MCSI2024\SPWM_3mod_hdl.v
...
module SPWM_3mod_hdl
  ...
  input   reset;
  input   clk_enable;
  input   [7:0] V_ref_0;  // uint8
  input   [7:0] V_ref_1;  // uint8
  input   [7:0] V_ref_2;  // uint8
  output  ce_out;
  ...
  assign Relational_Operator_relop1 = V_ref_0 >= HDL_Counter_out1;


  assign Relational_Operator1_relop1 = V_ref_1 >= HDL_Counter_out1;


  assign Relational_Operator2_relop1 = V_ref_2 >= HDL_Counter_out1;
  ...
  Maximum_Calculator u_Maximum_Calculator (.alpha3_phase_Vab0(V_ref_0),  // uint8
                                           .alpha3_phase_Vab120(V_ref_1),  // uint8
                                           .alpha3_phase_Vab240(V_ref_2),  // uint8
                                           .g_max(y_1)  // ufix6
                                           );
  assign y_2 = y_1;
  ...
  assign Relational_Operator3_relop1 = V_ref_0 >= HDL_Counter4_out1;


  assign Relational_Operator4_relop1 = V_ref_1 >= HDL_Counter4_out1;


  assign Relational_Operator5_relop1 = V_ref_2 >= HDL_Counter4_out1;
  ...
  assign Relational_Operator6_relop1 = V_ref_0 >= HDL_Counter5_out1;


  assign Relational_Operator7_relop1 = V_ref_1 >= HDL_Counter5_out1;


  assign Relational_Operator8_relop1 = V_ref_2 >= HDL_Counter5_out1;
